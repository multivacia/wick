...
| UX_R2_STATUS / UX-R2_STATUS | **REMAINING_RELEASE_INTEGRAL_PLAN_MERGED** |
...
| UX_R2_PRODUCT_CODE_AUTHORIZED | **false** (remaining UX-R2 product code unauthorized until separate execution prompt; I1 already merged) |
