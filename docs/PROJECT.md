...
| UX_R3_IMPLEMENTATION_AUTHORIZED | **false** (I1 consumed; no further UX-R3 product authorized) |
| UX_R3_I1_IMPLEMENTATION_AUTHORIZED | **true** (consumed by PR #130 merge) |
| UX_R3_START_AUTHORIZED | **true** (I1 merged; I2–I5 not authorized) |
