...
| UX_R4_DISCOVERY_AND_SCOPE_STATUS | **COMPLETE** (draft discovery PR; unmerged) |
...
| UX_R4_DISCOVERY_AUTHORIZED | **true** (consumed by this discovery assessment; unmerged) |
...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R4_I1_DECISION_LEDGER_AUTHORIZATION_ASSESSMENT** (UX-R4 discovery SCOPE_RECOMMENDED; I1 auth not started) |
