...
| UX_R4_I1_STATUS | **MERGED** (PR #138 → `6d6fde5`) |
| UX_R4_I1_DECISION | **AUTHORIZED_WITH_CONDITIONS** |
| UX_R4_I1_DECISION_LEDGER_AUTHORIZATION_ASSESSMENT_STATUS | **MERGED** (PR #138 → `6d6fde5`) |
| UX_R4_I1_AUTHORIZATION_STATUS | **MERGED** (PR #138 → `6d6fde5`) |
| UX_R4_I1_AUTHORIZATION_DECISION | **AUTHORIZED_WITH_CONDITIONS** |
| UX_R4_I1_ROUTE | **/governance/evidence** |
| UX_R4_I1_INTEGRATION_MODE | **B_NEW_SECTION_ABOVE_CATALOG** |
| UX_R4_I1_FIXTURE | **governed_decision_ledger_current_state_illustrative** |
| UX_R4_I1_VIEWMODEL | **GovernedDecisionLedgerViewModel** |
...
| UX_R4_I2_STATUS | **MERGED** (PR #140 → `f3f42ab`) |
| UX_R4_I2_IMPLEMENTATION_AUTHORIZED | **true** (consumed by PR #140 merge) |
| UX_R4_I2_EVIDENCE_DECISION_LEDGER_FIXTURE_REFRESH_STATUS | **MERGED** (PR #140 → `f3f42ab`) |
| UX_R4_I2_FINAL_REVIEW_STATUS | **APPROVED** |
| UX_R4_I2_ROUTE | **/governance/evidence** |
| UX_R4_I2_INTEGRATION_MODE | **B_NEW_SECTION_ABOVE_CATALOG** |
| UX_R4_I2_FIXTURE_NAME | **governed_decision_ledger_current_state_illustrative** |
| UX_R4_I2_VIEWMODEL_NAME | **GovernedDecisionLedgerViewModel** |
| UX_R4_I3_STATUS | **MERGED** (PR #143 → `2806216`) |
| UX_R4_I3_FIXTURE_ACCEPTANCE_AND_CLOSURE_STATUS | **MERGED** (PR #143 → `2806216`) |
| UX_R4_I3_FINAL_REVIEW_STATUS | **APPROVED** |
| UX_R4_I3_FINAL_REVIEW_DECISION | **APPROVED** |
| UX_R4_I3_IMPLEMENTATION_AUTHORIZED | **false** |
| UX_R4_I3_ASSESSMENT_AUTHORIZED | **true** (consumed by PR #143 merge) |
| UX_R4_HUMAN_FINAL_VALIDATION_RESULT | **APPROVED** |
| UX_R4_RELEASE_STATUS | **CLOSED** |
| UX_R4_RELEASE_ACCEPTANCE_STATUS | **ACCEPTED** |
| UX_R4_RELEASE_SCOPE | **FIXTURE_BACKED_GOVERNED_DECISION_LEDGER_AND_EVIDENCE_CATALOG_REFRESH** |
| UX_R4_ACCEPTANCE_WORDING | **UX-R4 fixture-backed governed decision-ledger and evidence-catalog refresh scope is complete, accepted, and governed.** |
| UX_R4_RELEASE_CLOSURE_AUTHORIZED | **true** (consumed by formal stamp) |
| UX_R4_RELEASE_MERGE_AUTHORIZED | **true** (consumed by PR #143 merge) |
...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R5_DISCOVERY_AND_SCOPE_ASSESSMENT** (UX-R4 CLOSED/ACCEPTED; UX-R5 not authorized) |
...
| 2026-07-24 | Merge PR #138 UX-R4 I1 Decision Ledger auth | Auth assessment MERGED; AUTHORIZED_WITH_CONDITIONS; sem implementação | `UX_R4_I1_AUTHORIZATION_STATUS=MERGED`; NEXT=I2 (não autorizado) |
| 2026-07-24 | Post-merge closure UX-R4 I1 auth (final-merge + merge-complete) | Handoffs + PROJECT reconciliado; sem MAIN_TIP-only | flags de implementação permanecem false; `PARALLEL_TASKS_ALLOWED=false` |
| 2026-07-24 | UX-R4 I2 Evidence Decision Ledger fixture refresh | Fixture-backed ledger section above catalog; review APPROVED; draft PR | UX-R4 IN_PROGRESS; I3 not started |
| 2026-07-24 | Merge PR #140 UX-R4 I2 decision ledger fixture refresh | I2 MERGED; ledger on /governance/evidence; sem I3 | `UX_R4_I2_STATUS=MERGED`; NEXT=I3 (não autorizado) |
| 2026-07-24 | Post-merge closure UX-R4 I2 (final-merge + merge-complete) | Handoffs + PROJECT reconciliado; sem MAIN_TIP-only | I3 NOT_STARTED; `PARALLEL_TASKS_ALLOWED=false` |
| 2026-07-24 | Stamp UX-R4 I2 MERGE-COMPLETE post-merge evidence | POST_MERGE_PR_STATUS=MERGED; PR #141 merge recorded | MAIN_TIP=`9796eb9`; I3 still NOT_STARTED |
