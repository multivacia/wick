...
| UX_R3_DISCOVERY_AND_SCOPE_STATUS | **COMPLETE** (draft PR pending merge) |
...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R3_FIRST_INCREMENT_AUTHORIZATION_ASSESSMENT** (UX-R3 discovery SCOPE_RECOMMENDED; implementation unauthorized) |
