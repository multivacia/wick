...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R2_I1_EVIDENCE_EXPLORER_IMPLEMENTATION** (I1 auth MERGED AUTHORIZED_WITH_CONDITIONS; implementation unauthorized until separate prompt) |
