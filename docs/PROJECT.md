...
| VIEWMODEL_IMPLEMENTATION_AUTHORIZED | **true** (I6B ViewModel merged; fixtures/screens still false) |
...
| I2_I5_I6_IMPL_AUTH_NEXT | **I6C_EXECUTABLE_FIXTURES_IMPLEMENTATION** (I6B MERGED; fixtures not authorized) |
