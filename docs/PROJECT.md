...
| UX_R4_I3_FIXTURE_ACCEPTANCE_AND_CLOSURE_STATUS | **COMPLETE_UNMERGED** |
| UX_R4_I3_FINAL_REVIEW_STATUS | **APPROVED** |
| UX_R4_I3_FINAL_REVIEW_DECISION | **APPROVED** |
| UX_R4_I3_IMPLEMENTATION_AUTHORIZED | **false** |
| UX_R4_I3_ASSESSMENT_AUTHORIZED | **true** (docs-only acceptance/closure) |
| UX_R4_RELEASE_STATUS | **IN_PROGRESS** (formal CLOSED proposed, not stamped) |
| UX_R4_RELEASE_ACCEPTANCE_STATUS | **PROPOSED_ACCEPTED_UNMERGED** |
| UX_R4_PROPOSED_RELEASE_SCOPE | **FIXTURE_BACKED_GOVERNED_DECISION_LEDGER_AND_EVIDENCE_CATALOG_REFRESH** |
| UX_R4_PROPOSED_ACCEPTANCE_WORDING | **UX-R4 fixture-backed governed decision-ledger and evidence-catalog refresh scope is complete, accepted, and governed.** |
...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R4_FINAL_HUMAN_VALIDATION_AND_MERGE** (I3 COMPLETE_UNMERGED; formal stamp unauthorized) |
