...
| UX_R3_I1_STATUS | **AUTHORIZATION_ASSESSMENT_COMPLETE** (draft PR pending merge) |
| UX_R3_I1_DECISION | **AUTHORIZED_WITH_CONDITIONS** |
| UX_R3_I1_COLLECTION_DATA_QUALITY_AUTHORIZATION_ASSESSMENT_STATUS | **COMPLETE** (draft PR pending merge) |
