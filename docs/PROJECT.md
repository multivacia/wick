...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R3_REMAINING_RELEASE_SINGLE_EXECUTION** (complete-release assessment MERGED REMAINING_SCOPE_RECOMMENDED; remaining unauthorized) |
