...
| UX_R3_I1_STATUS | **IMPLEMENTATION_COMPLETE** (draft PR #130) |
...
| UX_R3_I1_COLLECTION_DATA_QUALITY_IMPLEMENTATION_STATUS | **COMPLETE** (draft PR #130; awaiting human merge) |
...
| UX_R3_IMPLEMENTATION_AUTHORIZED | **true** (I1 Collection Data Quality only) |
| UX_R3_I1_IMPLEMENTATION_AUTHORIZED | **true** |
| UX_R3_START_AUTHORIZED | **true** (I1 started; I2–I5 not authorized) |
...
| I2_I5_I6_IMPL_AUTH_NEXT | **UX_R3_I1_COLLECTION_DATA_QUALITY_MERGE** (I1 implementation COMPLETE/APPROVED; awaiting human merge) |
