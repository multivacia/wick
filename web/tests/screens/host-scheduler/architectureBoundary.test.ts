...
const hostSchedulerRoot = join(testDir, "../../../src/screens/host-scheduler");
...
describe("Host/Scheduler screen architecture boundaries", () => {
  it("does not import network clients, credentials, or operational commands", () => {
    const files = listFiles(hostSchedulerRoot);
