...
```text
AUTHORIZED_WITH_CONDITIONS = documentation/data-contract for human merge consideration
I6A_DOCUMENTATION_MERGE_RECOMMENDED = true
IMPLEMENTATION_AUTHORIZED = false
...
```text
I6A_DOCUMENTATION_MERGE_RECOMMENDED=true; IMPLEMENTATION_AUTHORIZED=false; AUTHORIZED_WITH_CONDITIONS for docs merge only
AUTOMATIC_MERGE_AUTHORIZED = false
